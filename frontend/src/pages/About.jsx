    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4">
              About{" "}
              <span className="text-amber-400">Finntech Business Solutions</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-6">
            {services.map((service, index) => (
              <div
                key={index}
                className="group bg-white rounded-xl p-5 shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 hover:border-amber-200 hover:-translate-y-1"
              >
                <div className="w-11 h-11 bg-slate-900 rounded-lg flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300 shadow-md shadow-slate-900/20">
      ...
      <section className="py-10 sm:py-12 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white border-2 border-slate-200 rounded-2xl p-4 sm:p-6 md:p-8 shadow-sm">
              <div className="space-y-3 sm:space-y-4 text-base sm:text-lg text-slate-700 leading-relaxed">
                ...
                <div className="bg-slate-50 border-l-4 border-slate-900 p-3 sm:p-4 rounded-r-xl">
                  <p className="font-semibold text-slate-900 text-center leading-relaxed text-sm sm:text-base">
                ...
                <div className="bg-slate-900 text-white p-4 sm:p-6 rounded-xl mt-4 sm:mt-6 shadow-lg shadow-slate-900/20">
                  <p className="text-base sm:text-lg md:text-xl leading-relaxed text-center text-amber-50">
                    Whether you are looking to{" "}
                    <span className="font-bold text-amber-400">secure your dream home</span>,{" "}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="bg-amber-500 h-1 w-20 rounded"></div>
            </div>

            {/* Right Side - Stats */}
            <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6">
              <div className="bg-slate-50 border-2 border-slate-100 rounded-xl p-4 sm:p-6 text-center hover:shadow-lg transition-shadow">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 sm:p-6 hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 bg-slate-900 rounded-full flex items-center justify-center mb-3 sm:mb-4 shadow-md shadow-slate-900/20">
                <FaLightbulb className="text-xl text-amber-400" />
              </div>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-5 sm:p-6 hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 bg-slate-900 rounded-full flex items-center justify-center mb-3 sm:mb-4 shadow-md shadow-slate-900/20">
                <FaHandshake className="text-xl text-cyan-400" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2 sm:mb-3">
                Trusted Partnership
              </h3>
      ...
      <section className="py-10 sm:py-12 bg-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-slate-300 mb-5 sm:mb-6 leading-relaxed px-2">
          ...
          <button
            ...
            className="bg-white text-slate-900 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold text-base sm:text-lg hover:bg-slate-50 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105"
          >
            Get Started Today
          </button>
        </div>
